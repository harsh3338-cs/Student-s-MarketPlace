        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminRepliedById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportTickets_AspNetUsers_AdminRepliedById",
                        column: x => x.AdminRepliedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "DisplayOrder", "ImageUrl", "IsActive", "Placement", "TargetUrl", "Title" },
                values: new object[,]
                {
                    { 1, 1, "https://via.placeholder.com/300x250.png?text=Bookstore+Ad", true, 0, "#", "Campus Bookstore Sale" },
                    { 2, 1, "https://via.placeholder.com/728x90.png?text=Tech+Ad", true, 1, "#", "Tech Gadgets Discount" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportTickets_AdminRepliedById",
